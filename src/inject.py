...
def handle_syscall(pid, syscall_id, syscall_object, entering):
  ...
  handlers = {
    ...
    # sys_dup
    (32, True): generic_handlers.syscall_return_success_handler,
    (100, True): time_handlers.times_entry_handler,
    (100, True): kernel_handlers.brk_entry_handler,
    (100, False): kernel_handlers.brk_exit_handler,
    # sys_geteuid
    ...
    (11, False): generic_handlers.check_return_value_exit_handler,
    ...
    (40, True): send_handlers.sendfile_entry_handler,
    ...
    #  sys_madvise
    (28, True): generic_handlers.syscall_return_success_handler,
    (217, True): file_handlers.getdents64_entry_handler,
    # (221, True): file_handlers.fcntl64_entry_handler,
    # sys_dup3
    (292, True): generic_handlers.syscall_return_success_handler,
    # sys_fadvise64_64
    # (272, True): generic_handlers.syscall_return_success_handler,
    # sys_fadvise64
    (221, True): generic_handlers.syscall_return_success_handler,
    ...
    (290, True): file_handlers.eventfd2_entry_handler,
